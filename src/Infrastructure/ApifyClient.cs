...
namespace Producthunt.Console.Infrastructure;
...
public sealed class ApifyClient : IDisposable
{
    ...
    {
        var endpoint = $"acts/cloud9_ai~producthunt-scraper/run-sync-get-dataset-items?token={_token}";
...
{
    public string? DateUrl { get; init; }
    public int MaxResults { get; init; } = 10;
}
